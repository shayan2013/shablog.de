...
Don't be too late, It’s time for [Gutentor - Page Builder for Gutenberg](https://www.gutentor.com/)
...
Gutentor Blocks are categorized on 4 different types:
...
* Post Module
* Post Feature Module
* Advanced Post Module
* Post Carousel Module
* Post News Ticker Module
...
Gutentor elements are conceptualized to use inside the Gutentor Module but of course, you can use it anywhere on your editor. Gutentor elements are a small unit of Gutenberg blocks with all set of designing options, combining gutentor elements you can move up to the elegant blocks, sections and full page.
...
- EDD Cart Support
- Suggest us [here](https://wordpress.org/support/plugin/gutentor/)

Gutenberg Block in Gutentor Post

- **Post Module:** Display Blog Post with a list and grid view with a different template. Control each small unit of blog-post like feature image, title, excerpt, meta elements with advanced options, sort elements and so on.

- **Post Feature Module:** - Showcase your Blog Article Post with an attractive design template. Currently, we have 38 unique and lovely templates available with advanced design options. You can create an unlimited number of stunning blog section designs for your site and customize them as per your need. This block module is developed especially for blog, news or magazine sites.

- **Advanced Post Module:** - Advanced Post Module is a combination of multiple blocks like Post Module, Post Header and Post Footer. Post Header is a template combination of Gutentor Simple Text, Term Filter and Navigation. Similarly, Post Footer is a template combination of Gutentor Simple Text, Term Filter, Pagination, Navigation and Load more button. This module is the most advanced block we have ever build, try it out and control each element.

- **Post Carousel Module:** - Post Carousel Module use Post Module as an inner block. You have all options of Post Module on Post Carousel Module with added Advanced Carousel Options. Since we are using framework Slick Carousel, we have added almost all possible and useful options related to the Slick Carousel. Create beautiful and unique Post Carousel using our Post Carousel Module.

- **Post News Ticker Module:** - News Ticker is very important for Magazine and News Site. To create a news ticker module on Gutentor, we have developed our own jQuery library AcmeTicker. It includes all major and useful options to create News Ticker unique and beautiful.

=== 4. GUTENTOR WIDGET ===

Gutentor widgets are independent blocks, a very simple way to create your site section and blocks.

- **About:** Gutentor’s About block lets you add titles, photo, description and buttons to design the about section of your web page. You can choose the About Block design from 3 preset Template. Each individuals elements has its options for colour, margin-padding, typography, border and other necessary options.
...
* Fixed : Advanced Post Module prev/next and mobile full width CSS
...
* Fixed : CountUp
* Fixed : Advanced Post Module filter
* Fixed : Module Carousel arrow position

= 2.1.3 - 2020-06-12 =

MAJOR UPDATE on POST MODULE
You can now design your Blog, News and Magazine site without any limitations.

* Added : New Block => Advanced Post Module
* Added : New Block => Post Carousel Module
* Added : New Block => Post News Ticker Module
...
* Added : New advanced query control on Post and Post Feature Module
* Added : Advanced Column Sticky Options
* Added : Advanced Column 3-6-3 column template
* Updated : Advanced Column editor design
* Updated : Post Module to column management for Post Carousel
...
* Updated : Gutentor element dynamic CSS
...
* Fixed : Count Down CSS
* Fixed : Customizer CSS
* Fixed : Trying to access array offset on value of type bool on functions files
...
* Fixed: Addons Gutentor Block Widget Assets
* Fixed: Old button
...
* Added : Post Feature Module - Block
