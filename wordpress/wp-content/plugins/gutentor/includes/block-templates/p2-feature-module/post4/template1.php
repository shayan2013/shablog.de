...
if ( ! class_exists( 'Gutentor_P2_Post4_Template1' ) ) {

	/**
	 * Gutentor_P2_Post4_Template1 Class For Gutentor
	 *
	 * @package Gutentor
	 * @since 2.0.0
	 */
	class Gutentor_P2_Post4_Template1 extends Gutentor_Query_Elements {
...
Gutentor_P2_Post4_Template1::get_instance()->run();
