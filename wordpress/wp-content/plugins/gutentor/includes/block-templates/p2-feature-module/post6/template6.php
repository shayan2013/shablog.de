...
if ( ! class_exists( 'Gutentor_P2_Post6_Template6' ) ) {

	/**
	 * Gutentor_P2_Post6_Template6 Class For Gutentor
	 *
	 * @package Gutentor
	 * @since 2.0.0
	 */
	class Gutentor_P2_Post6_Template6 extends Gutentor_Query_Elements {
...
Gutentor_P2_Post6_Template6::get_instance()->run();
