...
if ( ! class_exists( 'Gutentor_P2_Post6_Template3' ) ) {

	/**
	 * Gutentor_P2_Post6_Template3 Class For Gutentor
	 *
	 * @package Gutentor
	 * @since 2.0.0
	 */
	class Gutentor_P2_Post6_Template3 extends Gutentor_Query_Elements {
...
Gutentor_P2_Post6_Template3::get_instance()->run();
