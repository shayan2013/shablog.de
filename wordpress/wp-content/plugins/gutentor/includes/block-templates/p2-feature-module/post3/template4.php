...
if ( ! class_exists( 'Gutentor_P2_Post3_Template4' ) ) {

	/**
	 * Gutentor_P2_Post3_Template4 Class For Gutentor
	 *
	 * @package Gutentor
	 * @since 2.0.0
	 */
	class Gutentor_P2_Post3_Template4 extends Gutentor_Query_Elements {
...
Gutentor_P2_Post3_Template4::get_instance()->run();
