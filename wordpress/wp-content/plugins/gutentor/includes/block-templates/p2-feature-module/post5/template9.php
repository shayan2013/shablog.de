...
if ( ! class_exists( 'Gutentor_P2_Post5_Template9' ) ) {

	/**
	 * Gutentor_P2_Post5_Template9 Class For Gutentor
	 *
	 * @package Gutentor
	 * @since 2.0.0
	 */
	class Gutentor_P2_Post5_Template9 extends Gutentor_Query_Elements {
...
Gutentor_P2_Post5_Template9::get_instance()->run();
