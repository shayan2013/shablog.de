...
if ( ! class_exists( 'Gutentor_P2_Post5_Template1' ) ) {

	/**
	 * Gutentor_P2_Post5_Template1 Class For Gutentor
	 *
	 * @package Gutentor
	 * @since 2.0.0
	 */
	class Gutentor_P2_Post5_Template1 extends Gutentor_Query_Elements {
		...
		public function template_data( $output, $the_query, $attributes ) {
			...
			while ( $the_query->have_posts() ) :
				$the_query->the_post();
				$output .= "<div class='" . apply_filters( 'gutentor_post_module_p2_grid_class', 'grid-lg-2m3 grid-md-2m3 grid-12', $attributes ) . "'>";
...
Gutentor_P2_Post5_Template1::get_instance()->run();
