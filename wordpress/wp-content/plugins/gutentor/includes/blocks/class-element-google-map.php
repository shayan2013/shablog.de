...
if ( ! class_exists( 'Gutentor_Element_Google_Map' ) ) {
	...
	class Gutentor_Element_Google_Map extends Gutentor_Block_Base {
		...
		public function render_callback( $attributes, $content ) {
			...
			$map_section_class = gutentor_concat_space( 'gutentor-element gutentor-element-google-map', $align );
			...
			$output  = '<' . $tag . ' class="' . apply_filters( 'gutentor_save_element_class', $map_section_class, $attributes ) . '" id="section-' . esc_attr( $blockID ) . '"   ' . GutentorAnimationOptionsDataAttr( $blockComponentAnimation ) . '>' . "\n";
...
Gutentor_Element_Google_Map::get_instance()->run();
